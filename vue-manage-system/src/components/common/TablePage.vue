    ...
    <div class="table">
        ...
        <el-dialog :title="getDialogTitle" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="50px" :rules="rules">
                <el-form-item  v-for="item in formCondition" :key="item.model" :label="item.name" :prop="item.model">
                    <form-item-by-type 
                    :item="item"
                    :formObj="form"
                    >
        ...
        methods: {
           ...
           //编辑弹出框
            handleEdit(row,type) {
                ...
                console.log('this.formCondition: ', this.formCondition);
                let len =  formCondition.length;
                let formObj = {
                    id:row.id
                }
                for (let i = 0; i < len; i++) {
                   let model = formCondition[i].model;
                   formObj[model] = row[model];
                }
                formObj.price = '122';
